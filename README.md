...
| 学习与实训 | [法律援助工作站](./legal-clinic) | 指导教师配置、学生导入培训、结构化接案、跨领域问题识别、期限追踪、备忘录框架、客户信函、学期交接。 |
| 生态工具 | [法律技能管理](./legal-builder-hub) | 社区技能发现与安装、质量评估、SHA 锁定更新、安装前信任检查。 |
...
| **中国裁判文书网** | 全国法院裁判文书检索 | `法律援助工作站`、`知识产权`、`争议解决`、`法学生` | 公开；可选 API |

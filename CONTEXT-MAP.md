...
维护 skill、reference、marketplace、MCP、cookbook 或 slash command 时，先读本文件和 `references/project-skill-location-checklist.md` 确认关系链、落点、版本和脱敏要求，再改对应 `SKILL.md`、reference 或 manifest。
...
| `references/project-skill-location-checklist.md` | 项目级 skill/reference 落点与脱敏检查清单。 | 新增或修改 skill、reference、marketplace、MCP、cookbook、公开维护说明前先读；不得作为可安装业务 skill 放入任一插件 `skills/` 目录。 |
...
- 新增或修改项目级 skill/reference/marketplace/MCP/cookbook/公开维护说明前，先按 `references/project-skill-location-checklist.md` 做落点、脱敏、版本、命令链和提交前验证检查。

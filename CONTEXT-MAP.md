...
维护 skill、reference、marketplace、MCP、cookbook 或 slash command 时，先读本文件和 `.codex/skills/legal-skills-cn-maintenance/SKILL.md` 确认关系链、落点、版本和脱敏要求，再改对应 `SKILL.md`、reference 或 manifest。
...
- 新增或修改项目级 skill/reference/marketplace/MCP/cookbook/公开维护说明前，先按 `.codex/skills/legal-skills-cn-maintenance/SKILL.md` 做落点、脱敏、版本、命令链和提交前验证检查。

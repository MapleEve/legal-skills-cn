...
与 [`corporate-legal`](../../corporate-legal) 插件同一来源——本目录为 `POST /v1/agents` 的自动化工作流模板。网格模式即 `tabular-review` 技能，在提取工作节点集群上以无人工界面模式运行。

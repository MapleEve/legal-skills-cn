...
description: >
  ...
  当用户说"整理[subject]知识体系"、"添加到我的知识体系"、"从这些材料构建知识体系"或指向课程材料时使用。
...
1. 加载 `~/.claude/plugins/config/claude-for-legal-cn/law-student/CLAUDE.md` → 知识体系偏好、已有体系。
2. 使用以下工作流。

...
description: >
  ...
  不添加境外模板式免责声明。当学生需向当事人发送常规函件时使用。
...
中使用中国法律文件格式，不添加境外模板式免责声明或与中国法律援助身份不匹配的身份提示。
...
4. **标记审查项。** 任何需要指导教师审查的实质性内容以 `[需审查]` 标记。
...
- **禁止要素：** 不写境外模板式法律意见免责声明、不写与中国法律援助身份不匹配的保密特权声明、不引用境外职业规则。如需保密提示，使用"本函所涉信息涉及您的个人隐私，请妥善保管。"
...
- 不直接发送函件——仅起草供审查
- 不在函件中添加境外模板式免责声明或与中国法律援助身份不匹配的身份提示
